...
var genEllipsis = function genEllipsis(dom, item, text) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_tooltip["default"], {
    title: text
  }, /*#__PURE__*/_react["default"].createElement("div", null, dom));
};
...
var ProTable = function ProTable(props) {
  ...
  var _k = (0, _react.useState)(proColumns),
      tableColumns = _k[0],
      setTableColumns = _k[1];

  var _l = (0, _react.useState)(proSize || 'large'),
      tableSize = _l[0],
      setTableSize = _l[1];
  /***********************密度设置**************************/
  ...
  var _m = (0, _hooks.useRowSelection)(tableColumns, rowKey, dataSource, propsRowSelection, optimize, onSelectedRowKeysUpdate),
      columns = _m.columns,
  ...
  var toolbar = (0, _react.useMemo)(function () {
    if (optimize) {
      return toolBarRender === false ? null : /*#__PURE__*/_react["default"].createElement(_toolBar["default"], {
  ...
  var table = (0, _react.useMemo)(function () {
    return /*#__PURE__*/_react["default"].createElement(_FitTable["default"], __assign({}, rest, {
      scroll: propsScroll,
      size: size,
...
var ProviderWarp = function ProviderWarp(props) {
  return /*#__PURE__*/_react["default"].createElement(_configProvider2.ConfigConsumer, null, function (_a) {
    var getPrefixCls = _a.getPrefixCls;
    return /*#__PURE__*/_react["default"].createElement(ProTable, __assign({
