...
var JsonForm = function JsonForm(props, ref) {
  ...
  var form = _form["default"].useForm(proForm)[0]; /// api 重定义


  var getFieldsValue = (0, _react.useCallback)(function (nameList, filterFunc) {
    if (nameList === void 0) {
      nameList = true;
    }
  ...
  var getFieldValue = (0, _react.useCallback)(function (name) {
    var values = getValues();
  ...
  var validateFields = (0, _react.useCallback)(function () {
