...
var getFormItem = function getFormItem(_a, form, labelClassName, itemCol, itemRow, index, hide) {
  ...
  if (_Password2["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_Password2["default"], __assign({
      key: String(name),
  ...
  if (_Switch["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_Switch["default"], __assign({
      key: String(name),
      labelClassName: labelClassName
    }, field, {
      type: type,
  ...
  if (_Label["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_Label["default"], __assign({
      key: String(name),
      labelClassName: labelClassName
    }, field, {
      type: type,
  ...
  if (_Label2["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_Label2["default"], __assign({
      key: String(name),
      labelClassName: labelClassName
    }, field, {
      type: type
  ...
  if (_Password["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_Password["default"], __assign({
      key: String(name),
      labelClassName: labelClassName
    }, field, {
      type: type,
  ...
  if (_CustomFragment["default"].typeList.includes(type)) {
    return _react["default"].createElement(_CustomFragment["default"], __assign({
      key: String(index)
    }, field, {
      type: type,
      form: form
  ...
  if (_TreeSelect["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_TreeSelect["default"], __assign({
      key: String(name),
      labelClassName: labelClassName
    }, field, {
      type: type,
  ...
  if (_LoadingItem["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_LoadingItem["default"], __assign({
      key: String(name)
  ...
  if (_NumberRange["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_NumberRange["default"], __assign({
      key: String(name),
      labelClassName: labelClassName
    }, field, {
      type: type,
  ...
  if (_TreeItem["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_TreeItem["default"], __assign({
      key: String(name),
      labelClassName: labelClassName
    }, field, {
      type: type,
  ...
  if (_CollapseLayout["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_CollapseLayout["default"], __assign({
      key: String(index),
      labelClassName: labelClassName
    }, field, {
      type: type,
  ...
  if (_Select2["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_Select2["default"], __assign({
      key: String(index),
      labelClassName: labelClassName
    }, field, {
      type: type,
  ...
  if (_Input2["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_Input2["default"], __assign({
      key: String(index),
      labelClassName: labelClassName
    }, field, {
      type: type,
  ...
  if (_CheckboxGroup2["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_CheckboxGroup2["default"], __assign({
      key: String(index),
      labelClassName: labelClassName
    }, field, {
      type: type,
  ...
  if (_DateRanger2["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_DateRanger2["default"], __assign({
      key: String(index),
      labelClassName: labelClassName
    }, field, {
      type: type,
  ...
  if (_NumberRange2["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_NumberRange2["default"], __assign({
      key: String(index),
      labelClassName: labelClassName
    }, field, {
      type: type,
  ...
  if (_RadioGroup2["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_RadioGroup2["default"], __assign({
      key: String(index),
      labelClassName: labelClassName
    }, field, {
      type: type,
  ...
  if (_Cascader2["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_Cascader2["default"], __assign({
      key: String(index),
      labelClassName: labelClassName
    }, field, {
      type: type,
  ...
  if (_DatePicker2["default"].typeList.includes(type)) {
    return getColChildren(_react["default"].createElement(_DatePicker2["default"], __assign({
      key: String(index),
      labelClassName: labelClassName
    }, field, {
      type: type,
...
var JsonForm = function JsonForm(props, ref) {
  ...
  var collapseBtn = (0, _react.useMemo)(function () {
    if (enableCollapse) {
      ...
      }, collapse ? _react["default"].createElement(_react["default"].Fragment, null, "\u6536\u8D77", _react["default"].createElement(_icons.UpOutlined, null)) : _react["default"].createElement(_react["default"].Fragment, null, "\u5C55\u5F00", _react["default"].createElement(_icons.DownOutlined, null))));
    } else {
      return null;
    }
  ...
  var formContent = (0, _react.useMemo)(function () {
    return _react["default"].createElement(_react["default"].Fragment, null, fromItemList, wrapChildren);
  ...
  return (0, _react.useMemo)(function () {
    if (enableCollapse) {
      ...
      }, _react["default"].createElement(_form["default"], __assign({
        layout: "inline"
      }, _props, {
        form: form,
        className: className
