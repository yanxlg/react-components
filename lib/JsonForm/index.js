...
exports["default"] = exports.getFormItems = exports.getColChildren = void 0;
...
var JsonForm = function JsonForm(props, ref) {
  ...
  defaultCollapse = _b === void 0 ? true : _b,
      ...
      proForm = props.form,
      _d = props.className,
      className = _d === void 0 ? _form2["default"].formContainer : _d,
  ...
  var getValues = (0, _react.useCallback)(function (targetFieldList) {
    ...
    target.map(function (field) {
      ...
      if (_layout["default"].typeList.includes(type)) {
        ...
        if (_Input["default"].typeList.includes(type)) {
          values[name_1] = _Input["default"].formatter(formatter)(form.getFieldValue(name_1));
        } else if (_Select["default"].typeList.includes(type)) {
          values[name_1] = _Select["default"].formatter(formatter)(form.getFieldValue(name_1));
          ...
          values[name_1] = _DatePicker["default"].formatter(formatter)(form.getFieldValue(name_1));
...
var JsonFormComponent = (0, _react.forwardRef)(JsonForm);
JsonFormComponent.FormItem = _FormItem["default"];
var _default = JsonFormComponent;
