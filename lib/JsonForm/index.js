  ...
  var getValues = (0, _react.useCallback)(function (targetFieldList) {
    ...
    target.map(function (field) {
      ...
      if (_Label["default"].typeList.includes(type)) {// 没有值需要获取
        ...
        if (_Input["default"].typeList.includes(type) || _TextArea["default"].typeList.includes(type) || _Select["default"].typeList.includes(type) || _DatePicker["default"].typeList.includes(type) || _Select2["default"].typeList.includes(type)) {
