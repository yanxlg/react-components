...
var CollapseLayout = function CollapseLayout(props) {
  ...
  var icon = (0, _react.useMemo)(function () {
    if (expandIcon) {
      return function (props) {
        ...
        return /*#__PURE__*/_react["default"].cloneElement(_icon, __assign(__assign({}, _icon.props), {
  ...
  return /*#__PURE__*/_react["default"].createElement(_collapse["default"], __assign({
    className: _form["default"].formCollapse
  }, _props, {
    activeKey: key,
    onChange: onMixChange,
    expandIcon: icon
  }), /*#__PURE__*/_react["default"].createElement(_collapse["default"].Panel, __assign({
    header: isHeaderFormComponent ? (0, _index.getFormItems)([_header], form) : _header
