    ...
    case 'collapse':
      ...
      return _react["default"].createElement(_collapse["default"], __assign({
        expandIcon: function expandIcon(_a) {
          ...
          return _react["default"].createElement(_lib.CaretRightOutlined, {
            rotate: isActive ? 90 : 0
          });
        }
      }, __props), _react["default"].createElement(_collapse["default"].Panel, __assign({}, panelProps, {
        header: (0, _index.getFormItems)([panelProps.header], form, labelClassName, itemCol, itemRow)
      }), (0, _index.getFormItems)(fieldList, form, labelClassName, itemCol, itemRow)));
