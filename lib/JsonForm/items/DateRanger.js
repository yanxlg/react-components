...
var FormDateRanger = function FormDateRanger(props) {
  ...
  return (0, _react.useMemo)(function () {
    var itemClassName = (0, _classnames["default"])(_form["default"].formInline, _form["default"].inlineBlock, _form["default"].marginNone, _form["default"].verticalMiddle);
    return _react["default"].createElement(_antd.Form.Item, {
      ...
      return _react["default"].createElement(_antd.Form.Item, {
        name: name1,
        className: _form["default"].marginNone,
        rules: rules === null || rules === void 0 ? void 0 : rules[0]
      }, _react["default"].createElement(_antd.DatePicker, __assign({
      ...
      className: [_form["default"].formColon, _form["default"].verticalMiddle].join(' ')
    }, "-"), _react["default"].createElement(_antd.Form.Item, {
      className: itemClassName,
      shouldUpdate: function shouldUpdate(prevValues, currentValues) {
