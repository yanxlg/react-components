  ...
  return (0, _react.useMemo)(function () {
    ...
    return _react["default"].createElement(_form["default"].Item, {
      ...
      return _react["default"].createElement(_form["default"].Item, {
        ...
        normalize: formatter1 ? formatter1 === 'start_date' ? _date.startDateToUnix : formatter1 === 'end_date' ? _date.endDateToUnix : _utils.transNullValue : _utils.transNullValue
      ...
      return _react["default"].createElement(_form["default"].Item, {
        ...
        normalize: formatter2 ? formatter2 === 'start_date' ? _date.startDateToUnix : formatter2 === 'end_date' ? _date.endDateToUnix : _utils.transNullValue : _utils.transNullValue
      }, _react["default"].createElement(_datePicker["default"], __assign({
        disabledDate: function disabledDate(currentDate) {
