  ...
  (0, _react.useEffect)(function () {
    if (withRequest) {
      ...
      (service ? service() : request.get(url)).then(function (result) {
        ...
        var parseOptions = parser_1 === 'array' ? parseOptionList(values, optionKeys, relation === null || relation === void 0 ? void 0 : relation.key) : (0, _.iterator)(values, function (key, value) {
          return {
            label: value,
            value: key
          };
