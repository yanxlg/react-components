...
exports.getValueByNamePath = getValueByNamePath;
exports.parseOptionList = parseOptionList;
...
function parseOptionList(options, optionKeys, relationKey, skipChildren) {
  ...
  if (relationKey) {
    return options.map(function (_a) {
      ...
      }, _b[relationKey] = parseOptionList(children || [], optionKeys, relationKey, skipChildren), _b)), skipChildren || relationKey === 'children' ? {} : {
        children: children
      });
    });
  } else {
...
var FormSelect = function FormSelect(props) {
  ...
  var _e = (0, _react.useState)(withList ? parseOptionList(options, optionKeys, relation === null || relation === void 0 ? void 0 : relation.key, skipChildren) : undefined),
      mergeOptions = _e[0],
  ...
  (0, _react.useEffect)(function () {
    if (withRequest) {
      ...
      (service ? service() : request.get(url)).then(function (result) {
        ...
        var parseOptions = parser_1 === 'array' ? parseOptionList(values, optionKeys, relation === null || relation === void 0 ? void 0 : relation.key, skipChildren) : (0, _iterator.iterator)(values, function (key, value) {
          return {
            label: value,
            value: key
          };
  ...
  var g_normalise = (0, _react.useCallback)(function (list) {
  ...
  var formItem = (0, _react.useCallback)(function () {
    ...
    return /*#__PURE__*/_react["default"].createElement(_form["default"].Item, __assign({
    ...
    }, formItemProps), multiple ? /*#__PURE__*/_react["default"].createElement(_treeSelect["default"], __assign({
      ...
      dropdownClassName: _form2["default"].customTreeSelect,
      className: _form2["default"].formItemDefault,
      choiceTransitionName: ''
    }, childrenProps, eventProps, {
      loading: loading,
      treeData: data
    })) : /*#__PURE__*/_react["default"].createElement(_select["default"], __assign({
      className: _form2["default"].formItemDefault
    }, childrenProps, {
      options: data,
      loading: loading
