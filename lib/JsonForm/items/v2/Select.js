...
function parseOptionList(options, optionKeys, relationKey) {
  if (relationKey) {
...
var FormSelect = function FormSelect(props) {
  ...
  var _d = (0, _react.useState)(withList ? parseOptionList(options, optionKeys, relation === null || relation === void 0 ? void 0 : relation.key) : undefined),
      mergeOptions = _d[0],
  ...
  (0, _react.useEffect)(function () {
    if (withRequest) {
      ...
      (service ? service() : request.get(url)).then(function (result) {
        ...
        var parseOptions = parser_1 === 'array' ? parseOptionList(values, optionKeys, relation === null || relation === void 0 ? void 0 : relation.key) : (0, _iterator.iterator)(values, function (key, value) {
          return {
            label: value,
            value: key
          };
