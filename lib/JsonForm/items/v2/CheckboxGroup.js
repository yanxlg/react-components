...
var FormCheckboxGroup = function FormCheckboxGroup(props) {
  ...
  var _d = (0, _react.useState)(withList ? (0, _Select.parseOptionList)(options, optionKeys) : undefined),
      mergeOptions = _d[0],
  ...
  (0, _react.useEffect)(function () {
    if (withRequest) {
      ...
      (service ? service() : request.get(url)).then(function (result) {
        ...
        var parseOptions = parser_1 === 'array' ? (0, _Select.parseOptionList)(values, optionKeys) : (0, _iterator.iterator)(values, function (key, value) {
          return {
            label: value,
            value: key
          };
  ...
  return (0, _react.useMemo)(function () {
    ...
    }, formItemProps), loading && showLoading ? /*#__PURE__*/_react["default"].createElement(_spin["default"], {
      spinning: true
    }) : /*#__PURE__*/_react["default"].createElement(_checkbox["default"].Group, __assign({}, childrenProps, {
      options: options
    }, eventProps)));
  }, [mergeOptions, reduxOptions, childrenProps, formItemProps]);
};
