...
var FormSelect = function FormSelect(props) {
  var name = props.name,
      label = props.label,
      _a = props.className,
      className = _a === void 0 ? _form["default"].formItemDefault : _a,
  ...
  return (0, _react.useMemo)(function () {
    if (optionListDependence === void 0) {
      ...
      return _react["default"].createElement(_antd.Form.Item, {
        ...
        rules: rules
      }, _react["default"].createElement(_antd.Select, __assign({
        className: className,
        loading: loading,
        mode: mode,
      ...
      }), syncDefaultOption ? _react["default"].createElement(_antd.Select.Option, {
      ...
      return _react["default"].createElement(_antd.Form.Item, {
        ...
        return _react["default"].createElement(_antd.Form.Item, {
          ...
          className: className,
          loading: loading
        }, eventProps), syncDefaultOption ? _react["default"].createElement(_antd.Select.Option, {
          value: syncDefaultOption.value
        }, syncDefaultOption.name) : null, list.map(function (item) {
          return _react["default"].createElement(_antd.Select.Option, {
            key: item.value,
