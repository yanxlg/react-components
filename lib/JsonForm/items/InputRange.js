...
var FormInputRange = function FormInputRange(props) {
  ...
  return (0, _react.useMemo)(function () {
    var itemClassName = [_form["default"].formInline, _index["default"].inlineBlock, _index["default"].marginNone, _index["default"].verticalMiddle].join(' ');
    return _react["default"].createElement(_antd.Form.Item, {
      ...
      name: name1,
      className: _index["default"].marginNone,
      validateTrigger: "onBlur",
      rules: rules === null || rules === void 0 ? void 0 : rules[0]
    }, _react["default"].createElement(_antd.InputNumber, __assign({
      min: 0,
      precision: precision,
      className: className
    }, event1Props)))), _react["default"].createElement("span", {
      className: [_form["default"].formColon, _index["default"].verticalMiddle].join(' ')
    }, "-"), _react["default"].createElement(_antd.Form.Item, {
      className: itemClassName,
      shouldUpdate: function shouldUpdate(prevValues, currentValues) {
