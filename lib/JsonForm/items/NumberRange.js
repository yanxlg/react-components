...
var FormNumberRange = function FormNumberRange(props) {
  var name = props.name,
      ...
      label = props.label,
      _a = props.className,
      className = _a === void 0 ? _form2["default"].inputRange : _a,
  ...
  return (0, _react.useMemo)(function () {
    return /*#__PURE__*/_react["default"].createElement(_form["default"].Item, {
    ...
    }, /*#__PURE__*/_react["default"].createElement(_RichInput["default"], __assign({
      richType: _type,
      placeholder: placeholder,
      className: (0, _classnames["default"])(className, _form2["default"].inputRangeLeft)
    }, _props))), /*#__PURE__*/_react["default"].createElement(_input["default"], {
      ...
      richType: _type,
      placeholder: placeholder,
      className: (0, _classnames["default"])(className, _form2["default"].inputRangeRight)
    }, _props)))));
  }, [_props, hide]);
};
