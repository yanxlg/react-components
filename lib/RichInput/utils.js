...
exports.naturalNumber = exports.numberSplit = exports.positiveIntFormatter = exports.intFormatter = exports.numberFormatter = void 0;
...
var numberSplit = function numberSplit(value) {
  return typeof value === 'number' ? String(value) : value ? (/^\d+\,?\d*/.exec(value) || [''])[0] : '';
};

exports.numberSplit = numberSplit;

var naturalNumber = function naturalNumber(value) {
  return typeof value === 'number' ? String(value) : value ? (/^-?\d+(\.\d*)?/.exec(value) || [''])[0] : '';
};
