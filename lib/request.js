...
function addDefaultInterceptors(req) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (!response) {
              !skipResponseInterceptors && _message["default"].error('服务异常，无结果返回！');
              throw response;
            }
            ...
            if (status < 200 || status >= 300) {
              ...
              !skipResponseInterceptors && msg && _message["default"].error(status + "\uFF1A" + msg);
              throw {
                type: 'HttpError',
                data: response.body,
                message: msg
          ...
          case 2:
            ...
            if (!successReg.test(String(state))) {
              !skipResponseInterceptors && _message["default"].error(msg);
          ...
          case 3:
            ...
            !skipResponseInterceptors && _message["default"].error('服务异常，返回结果无法解析！');
            throw {
              type: 'HttpError',
              data: response.body,
              response: response,
  ...
  req.interceptors.request.use(function (url, options) {
    ...
    var params = options.params,
        ...
        extra = __rest(options, ["params", "data", "excludeKeys"]);

    return {
      url: url,
      options: __assign(__assign({}, extra), {
        params: params ? (0, _utils.clearEmptyVal)(params, excludeKeys) : undefined,
        data: data ? (0, _utils.clearEmptyVal)(data, excludeKeys) : undefined
      })
    };
  }, {
    global: false
  ...
  req.interceptors.request.use(function (url, options) {
    if (options === null || options === void 0 ? void 0 : options.cancelToken) {
      var controller_1 = new _abortController["default"](); // fetch abort
...
var request = (0, _umiRequest.extend)({
  errorHandler: function errorHandler(err) {
    if (request.isCancel(err) || typeof err === 'object' && /abort/.test(err.message)) {
      throw new _umiRequest["default"].Cancel(err.message); // abort统一抛出异常，不进行处理
    }
