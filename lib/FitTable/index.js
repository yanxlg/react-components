...
function FitTable(_a) {
  ...
  var _g = (0, _react.useState)(columns),
      filterColumns = _g[0],
      setFilterColumns = _g[1];

  var scroll = (0, _hooks.useScrollXY)(ref, bottom, minHeight, autoFitY, showColumnsSetting ? filterColumns : columns, rowSelection, propsScroll);
  ...
  var onFilterColumns = (0, _react.useCallback)(function (columns) {
    setFilterColumns(columns);
  }, []);
  ...
  var setting = (0, _react.useMemo)(function () {
    return _react["default"].createElement(_ColumnsSetting["default"], {
      columns: columns,
  ...
  return (0, _react.useMemo)(function () {
    ...
    }, showColumnsSetting ? setting : null, _react["default"].createElement(_table["default"], __assign({
      scroll: scroll,
      columns: _columns,
