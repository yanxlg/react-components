...
function FitTable(_a) {
  ...
  var moveColumn = (0, _react.useCallback)(function (dragIndex, hoverIndex) {}, []); // columns转换
  ...
  var tableContent = (0, _react.useMemo)(function () {
    ...
    }, _react["default"].createElement(_table["default"], __assign({
      key: columns.length,
      scroll: scroll,
      // @ts-ignore
      columns: _columns,
