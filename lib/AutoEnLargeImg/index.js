...
var AutoEnLargeImg = function AutoEnLargeImg(_a) {
  ...
  return (0, _react.useMemo)(function () {
    if (Array.isArray(srcList) && srcList.length > 0) {
      ...
      }, /*#__PURE__*/_react["default"].createElement(_LazyImage["default"], __assign({
        src: srcList[0],
        className: className,
        alt: ""
      }, props)));
    ...
    return src || children ? /*#__PURE__*/_react["default"].createElement(_popover["default"], {
      placement: "right",
      content: src ? /*#__PURE__*/_react["default"].createElement("img", {
      ...
      title: null,
      autoAdjustOverflow: true
    }, src ? noLazy ? /*#__PURE__*/_react["default"].createElement("img", __assign({
      src: src,
      className: className,
      alt: ""
    }, props)) : /*#__PURE__*/_react["default"].createElement(_LazyImage["default"], __assign({
      src: src,
      className: className,
      alt: ""
    }, props)) : children) : null;
