...
var getButtonText = function getButtonText(_a, config) {
  return {
    ...
    density: {
      text: '表格密度',
      icon: _react["default"].createElement(_DensityIcon["default"], {
...
var ToolBar = function ToolBar(_a, ref) {
  ...
  return (0, _react.useMemo)(function () {
    ...
    }, optionDom.length > 0 && actions.length > 0 && _react["default"].createElement(_antd.Divider, {
      type: "vertical"
    }), optionDom)));
  }, [actions, optionDom, toolBarRender]);
};

var ToolbarWrap = (0, _react.forwardRef)(ToolBar);
...
var WarpToolBar = function WarpToolBar(props) {
  return _react["default"].createElement(_context.ConfigConsumer, null, function (_a) {
    ...
    return _react["default"].createElement(ToolbarWrap, __assign({
      className: className
    }, _props, {
      ref: toolbarRef
    }));
