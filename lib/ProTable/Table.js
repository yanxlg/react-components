...
var genCopyable = function genCopyable(dom, item) {
  if (item.copyable || item.ellipsis) {
    return _react["default"].createElement(_antd.Typography.Paragraph, {
      style: {
...
var ProTable = function ProTable(props) {
  ...
  if (proColumns.length < 1) {
    return _react["default"].createElement(_antd.Empty, null);
  }
...
var ProviderWarp = function ProviderWarp(props) {
  return _react["default"].createElement(_configProvider.ConfigConsumer, null, function (_a) {
